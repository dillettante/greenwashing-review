...
**표준 설치는 `git clone`이다** — [README.md](README.md) §2를 따른다. 이 문서는 그것이 어려운 경우,
즉 **공개 저장소를 클론할 수 없거나 자체 완결 번들이 필요한 환경**(망분리·기밀, 공개 git 미사용 로펌 등)을
위한 **zip 배포** 방법이다. 표준 사용자는 이 문서가 필요 없다.
